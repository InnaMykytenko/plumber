...
class Swift_Smoke_InternationalSmokeTest extends SwiftMailerSmokeTestCase
{
    ...
    public function testAttachmentSending()
    {
        ...
        $message = Swift_Message::newInstance()
            ...
            ->setBody('This message should contain an attached ZIP files (named "κείμενο, εδάφιο, θέμα.zip").'.PHP_EOL.
                'When unzipped, the archive should produce a text files which reads:'.PHP_EOL.
