...
function generateUpToDateMimeArray()
{
    ...
    if (preg_match_all('/^#?([a-z0-9\-\+\/\.]+)[\t]+(.*)$/miu', $mime_types, $matches) !== false) {
        ...
        // wrap array for generating files
    ...
    // write mime_types.php config files
